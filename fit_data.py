...
def fit_mesh(mesh_src, mesh_tgt, args, device='cuda'):
    start_iter = 0
...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        render_vox_360(voxels_src, output_path='results/Prob_1_1-optimized_voxel.gif', image_size=512, device=args.device)
        render_vox_360(voxels_tgt, output_path='results/Prob_1_1-ground_truth_voxel.gif', image_size=512, device=args.device)
        ...
        render_points_360(pointclouds_src, output_path='results/Prob_1_2-optimized_pc.gif',image_size=512, device=args.device)
        render_points_360(pointclouds_tgt, output_path='results/Prob_1_2-ground_truth_pc.gif',image_size=512, device=args.device)
        ...
        render_mesh_360(mesh_src, output_path='results/Prob_1_3-optimized_mesh.gif', image_size=512, device=args.device)
        render_mesh_360(mesh_tgt, output_path='results/Prob_1_3-ground_truth_mesh.gif',image_size=512, device=args.device)
