...
def get_args_parser():
    ...
    parser.add_argument('--lr', default=10e-4, type=float)
    parser.add_argument('--max_iter', default=10000, type=int)
    parser.add_argument('--log_freq', default=1000, type=str)
    parser.add_argument('--batch_size', default=16, type=int)#2
    parser.add_argument('--num_workers', default=4, type=int)#0
    parser.add_argument('--type', default='vox', choices=['vox', 'point', 'mesh'], type=str)
    parser.add_argument('--n_points', default=5000, type=int)
    parser.add_argument('--w_chamfer', default=1, type=float)
...
def train_model(args):
    ...
    plt.savefig(f'results/{args.type}_loss.png')
    print('Done!')
